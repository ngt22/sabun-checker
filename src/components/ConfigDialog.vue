...
<template>
    <Dialog v-model:visible="visible" modal header="Configuration" :style="{ width: '35rem' }">
        <div class="config-content">
            ...
            <Fieldset legend="ハイライト設定" :toggleable="true" class="mb-4">
                <div class="field-checkbox">
                    <Checkbox v-model="config.highlightFullWidthSpace" inputId="highlightFullWidthSpace"
                        :binary="true" />
                    <label for="highlightFullWidthSpace">全角スペース (U+3000) をハイライト</label>
                </div>
                <div class="field-checkbox">
                    <Checkbox v-model="config.highlightHalfWidthSpace" inputId="highlightHalfWidthSpace"
                        :binary="true" />
                    <label for="highlightHalfWidthSpace">半角スペースをハイライト</label>
                </div>
                <div class="field-checkbox">
                    <Checkbox v-model="config.highlightHalfWidthSymbol" inputId="highlightHalfWidthSymbol"
                        :binary="true" />
                    <label for="highlightHalfWidthSymbol">半角記号をハイライト</label>
                </div>
                <div class="field-checkbox">
                    <Checkbox v-model="config.highlightHalfWidthAlpha" inputId="highlightHalfWidthAlpha"
                        :binary="true" />
                    <label for="highlightHalfWidthAlpha">半角英字 (a-z, A-Z) をハイライト</label>
                </div>
                <div class="field-checkbox">
                    <Checkbox v-model="config.highlightHalfWidthDigit" inputId="highlightHalfWidthDigit"
                        :binary="true" />
